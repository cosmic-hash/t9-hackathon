...
def explain_drug_from_json(fda_json):
    ...
    description = fda_json['results'][0]['description'][0]
    pharmacology = fda_json['results'][0]['clinical_pharmacology'][0]
    indications = fda_json['results'][0]['indications_and_usage'][0]
...
"spl_id": [
"024ac6b8-5ce0-4435-9b11-b1806c511d7b"
],
"spl_set_id": [
"024ac6b8-5ce0-4435-9b11-b1806c511d7b"
],
